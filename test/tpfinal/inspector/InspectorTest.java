...
public class InspectorTest {
	...
	public void testEstacionamientoVigente() {
		...
		// Verify
		assertTrue(inspector.verificarEstacionamiento(patente)); // Pasa el inspector, verifica que la patente se
																	// encuntra en el sistema
	}

	@Test
	public void testPatenteConInfracción() {
		// Verify
		assertFalse(inspector.verificarEstacionamiento(patente)); // Pasa el inspector, ve que la patente no se
